                ...
                <AboutMeSection className="swiper-no-swiping">
                  <div className="about__text">
                    ...
                    <AboutMeText>
                      ...
                      an&nbsp;internship at{" "}
                      <strong>Isobar Czech Republic</strong>, a&nbsp;digital
                      agency where I&nbsp;still work.
                    </AboutMeText>
                    <AboutMeText>
                      ...
                      or newsletters, built websites in{" "}
                      <strong>Vue/Nuxt</strong> and maintained legacy websites
                      in&nbsp;Laravel. My clients list includes ŠKODA Auto,
                      Sazka, Heineken, Sunar, Generali and other brands.
                    </AboutMeText>
                    <AboutMeText>
                      ...
                      <strong>React</strong> and I&nbsp;would like to continue
                      in this direction. I&nbsp;want to be able to build superb
                    ...
                    <AboutMeText>
                      Here are a&nbsp;few technologies and tools I've been
                  ...
                  <div className="button">
                    <Button href="/#about-me">Back</Button>
                  </div>
                </AboutMeSection>
              </SectionContent>
            </Section>
